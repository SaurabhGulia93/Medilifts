...
+ (MAToast *)shared
{
    ...
    static MAToast *shared=nil;
    dispatch_once(&onceToken,^{
        shared = [[MAToast allocWithZone:nil] init];
    });
    return shared;
}
...
- (void)setMessage:(NSString *)message
{
    ...
    CGSize size = [MAUtility sizeForString:message font:font width:kLOBBigContentWidth - 2.0 * _margin];
